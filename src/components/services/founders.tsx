...
export function Founders({ locale }: { locale: Locale }) {
  return (
    <section className="container py-10">
      <Reveal className="ticks border border-line p-8 md:p-12 bg-surface grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
        <div>
          <p className="font-mono text-xs uppercase tracking-wider text-accent">01 / {site.founders.heading[locale]}</p>
